...
<Flex justify={'space-around'}   display={{base:"none",md:"flex"}} mt={"2vw"} width={"85%"} borderTop={'2px solid black'}>
...
<Link href={"tel:08033848454"}  mt={"2vh"} _hover={{textDecoration:"none",color:"orange.500"}} fontWeight={600} fontSize={{base:"15px",md:'20px'}}  >+2348033848454</Link>
<Flex borderRight="2px solid" height={"40px"} mt={"2vh"} ></Flex>
...
<Flex className='flex-1' justify='center' align='center' border="1px solid">
    <Link href='/projects' color={"white"} fontWeight={700} _hover={{textDecoration:"none"}} p={"10px"}
     textAlign={'center'} height={"45px"} bg={"orange.500"}>Projects Overview</Link>
</Flex>
