...
<Flex flexDir={{base:"column",md:"row"}} justify={{base:"center",md:'space-between'}}  width={{base:"100%",md:"80%"}} >

     <Flex mb={{base:"3vh",md:"0"}} p={{base:"13px",md:"10px"}} width={{base:"100%",md:"300px"}} flexDir={"column"} boxShadow='2xl'  rounded='md' bg='transparent' position='relative'  className=' overflow-x-hidden '>
     ...
     <Flex p={{base:"13px",md:"10px"}} width={{base:"100%",md:"300px"}} flexDir={"column"} boxShadow='2xl'  rounded='md' bg='transparent' position='relative'  className=' overflow-x-hidden '>
